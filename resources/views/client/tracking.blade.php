    ...
    <div class="max-w-3xl mx-auto">
        ...
        <div class="glass-panel p-8 mb-6">
            <div class="text-center mb-6">
                ...
                <h2 class="text-xl font-bold mb-2">Track Your Shipment</h2>
                <p class="text-zinc-400">Enter your tracking number or AWB to get the latest status</p>
            </div>
            <form method="GET" action="{{ route('client.tracking') }}" class="flex gap-3">
                <input type="text" name="awb" value="{{ $awb }}" placeholder="Enter tracking number..." 
                ...
                <div class="glass-panel p-6">
                    ...
                    <div class="grid md:grid-cols-2 gap-6">
                        <div class="p-4 bg-zinc-800/50 rounded-lg">
                            <div class="text-xs text-zinc-500 uppercase mb-2">From</div>
                        ...
                        <div class="p-4 bg-zinc-800/50 rounded-lg">
                            <div class="text-xs text-zinc-500 uppercase mb-2">To</div>
                    ...
                    <div class="mt-6 pt-6 border-t border-white/10 flex justify-between text-sm">
                        ...
                        <div>
                            ...
                            <span>{{ number_format($shipment->weight ?? 0, 2) }} kg</span>
                        </div>
                        <div>
                            <span class="text-zinc-400">Service:</span>
                            <span class="capitalize">{{ $shipment->service_level ?? 'Standard' }}</span>
                        </div>
                    </div>
                </div>
            @else
                ...
                <div class="glass-panel p-8 text-center">
                    ...
                    <h3 class="text-lg font-medium mb-2">Shipment Not Found</h3>
                    <p class="text-zinc-400 mb-4">We couldn't find a shipment with tracking number: <span class="font-mono">{{ $awb }}</span></p>
                    <p class="text-sm text-zinc-500">Please check the tracking number and try again.</p>
                </div>
            @endif
        @endif
    </div>
