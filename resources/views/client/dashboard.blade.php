...
@section('content')
    ...
    <div class="glass-panel p-6 mb-6">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
                <h2 class="text-2xl font-bold">Welcome back, {{ $customer->contact_person }}!</h2>
                <p class="text-zinc-400 mt-1">Here's what's happening with your shipments today.</p>
            </div>
    ...
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        <div class="stat-card">
            <div class="flex items-center justify-between mb-3">
                ...
                <span class="text-xs text-zinc-500">All Time</span>
            </div>
            <div class="text-2xl font-bold">{{ number_format($stats['total_shipments']) }}</div>
            <div class="text-sm text-zinc-400">Total Shipments</div>
        </div>
        ...
        <div class="stat-card">
            <div class="flex items-center justify-between mb-3">
                ...
                <span class="text-xs text-zinc-500">Lifetime</span>
            </div>
            <div class="text-2xl font-bold">${{ number_format($stats['total_spent'], 0) }}</div>
            <div class="text-sm text-zinc-400">Total Spent</div>
        </div>
    </div>
    ...
    <div class="grid lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2 glass-panel">
            <div class="p-5 border-b border-white/10 flex items-center justify-between">
                ...
                <a href="{{ route('client.shipments.index') }}" class="text-sm text-red-400 hover:text-red-300">View All</a>
            </div>
            <div class="p-5">
                ...
                @else
                    <div class="text-center py-8">
                        ...
                        <p class="text-zinc-400 mb-3">No shipments yet</p>
                    ...
                    @if($customer->credit_limit > 0)
                        <div class="pt-3 border-t border-white/10">
                            <div class="flex justify-between text-sm mb-2">
                                <span class="text-zinc-400">Credit Used</span>
