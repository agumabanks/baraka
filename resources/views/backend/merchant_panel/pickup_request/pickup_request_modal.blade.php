    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content" id="data-modal">
        ...
        <div class="row pickup-request" style="margin:auto">
            <div class="col-6">
                <div class="btn btn-primary regular-btn font-bold" data-bs-toggle="modal" data-bs-target="#regular">
                    <h2 class="text-white mb-2"  ><b>{{ __('pickupRequest.regular') }}</b></h2>
                    <p>{{ __('pickupRequest.delivery') }}</p>
                </div>
            </div>
            <div class="col-6">
                <div class="btn btn-primary regular-btn font-bold" data-bs-toggle="modal" data-bs-target="#express">
