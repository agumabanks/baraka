...
@section('content')
    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
        <div class="flex items-center gap-4">
            <a href="{{ route('admin.clients.show', $customer) }}" class="p-2 rounded-lg hover:bg-white/10 transition-colors">
        ...
        <div class="flex gap-2">
            <a href="{{ route('admin.clients.statement.download', ['client' => $customer, 'start' => $start->format('Y-m-d'), 'end' => $end->format('Y-m-d')]) }}" 
