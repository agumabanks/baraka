    ...
    <tr class="hover:bg-white/[0.02] transition-colors group">
        ...
        <td class="px-4 py-3">
            <div class="flex items-center justify-end gap-1 opacity-50 group-hover:opacity-100 transition-opacity">
                <a href="{{ route('branch.clients.show', $customer) }}" class="p-2 rounded-lg hover:bg-white/10 transition-colors text-zinc-400 hover:text-white" title="View Details">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/>
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/>
                    </svg>
                </a>
                <a href="{{ route('branch.clients.edit', $customer) }}" class="p-2 rounded-lg hover:bg-blue-500/20 transition-colors text-blue-500" title="Edit">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/>
                    </svg>
                </a>
                <a href="{{ route('branch.clients.quick-shipment', $customer) }}" class="p-2 rounded-lg hover:bg-emerald-500/20 transition-colors text-emerald-500" title="New Shipment">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="relative dropdown-container">
                    ...
                    <div class="dropdown-menu hidden absolute right-0 mt-2 w-48 bg-zinc-900 border border-white/10 rounded-xl shadow-2xl z-50 py-1 overflow-hidden">
                        <a href="{{ route('branch.clients.statement', $customer) }}" class="flex items-center gap-2 px-4 py-2 text-sm text-zinc-300 hover:bg-white/5 hover:text-white transition-colors">
                        ...
                        <a href="{{ route('branch.clients.statement.download', $customer) }}" class="flex items-center gap-2 px-4 py-2 text-sm text-zinc-300 hover:bg-white/5 hover:text-white transition-colors">
                        ...
                        <a href="{{ route('branch.clients.contracts', $customer) }}" class="flex items-center gap-2 px-4 py-2 text-sm text-zinc-300 hover:bg-white/5 hover:text-white transition-colors">
                        ...
                        <form method="POST" action="{{ route('branch.clients.refresh-stats', $customer) }}">
                            @csrf
    ...
    <tr>
        <td colspan="7" class="px-4 py-16 text-center">
            <div class="flex flex-col items-center">
                ...
                <a href="{{ route('branch.clients.create') }}" class="inline-flex items-center gap-2 px-4 py-2 bg-emerald-600 hover:bg-emerald-700 rounded-lg font-medium text-sm transition-colors">
