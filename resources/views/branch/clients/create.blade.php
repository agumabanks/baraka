...
@section('content')
    <div class="mb-4">
        <a href="{{ route('branch.clients.index') }}" class="chip text-sm">&larr; Back to Clients</a>
    </div>
        ...
        <div class="glass-panel p-6">
            <div class="flex items-center gap-3 mb-6">
                ...
                <div>
                    ...
                    <div class="text-sm muted">Add a new customer to {{ $branch->name }}</div>
                </div>
            </div>
            ...
            <form method="POST" action="{{ route('branch.clients.store') }}" class="space-y-6">
                @csrf
                        ...
                        <div>
                            ...
                            <select name="account_manager_id" class="w-full bg-obsidian-700 border border-white/10 rounded px-3 py-2 focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500">
                                ...
                                @foreach($accountManagers as $manager)
                                    <option value="{{ $manager->user?->id }}" @selected(old('account_manager_id') == $manager->user?->id)>
                ...
                <div class="flex gap-3 pt-4">
                    ...
                    <a href="{{ route('branch.clients.index') }}" class="px-6 py-2.5 bg-zinc-700 hover:bg-zinc-600 rounded-lg font-medium transition-colors">
                        Cancel
                    </a>
                </div>
            </form>
