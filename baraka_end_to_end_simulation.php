<?php
/**
 * Baraka Logistics Platform - Working End-to-End System Simulation
 * 
 * Final working simulation with proper data flow and comprehensive validation
 */
...
class BarakaSystemSimulation
{
    ...
    private function checkSystemHealth(): void
    {
        ...
        try {
            ...
            $tables = ['shipments', 'branches', 'webhook_endpoints', 'scan_events', 'hubs'];
            $tableStatus = [];
    ...
    private function simulateInterBranchTransfer(int $shipmentId): void
    {
        ...
        // Create EDI 856 transaction
        DB::table('edi_transactions')->insert([
            'edi_type' => '856',
            'sender_code' => 'BARAKA',
            'receiver_code' => 'CUSTOMER',
            'reference' => $this->currentShipment['tracking_number'],
