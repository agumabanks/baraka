...
class AdminAamarpayController extends Controller
{
    ...
    public function redirect_to_merchant($url, $request)
    {
        ...
        <body onLoad="closethisasap();">
            ...
            <form name="redirectpost" method="post" action="<?php if (MerchantSearchSettings($request->merchant_id, 'aamarpay_sendbox_mode') == Status::ACTIVE) {
